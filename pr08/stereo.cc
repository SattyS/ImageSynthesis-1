...
Point3f Pe(0.5,0,0);      //camera or eye position
...
int main (int argc, char const* argv[])
{
	...
	Point3f Vview(0,-20,70),Vup(0,1,0);	// point the view vector to focus on a particular point from Pe
	//Vview = Point3f(0,0,1);
	//Vview = Vview - Pe;
	Vview.Normalize();
	//Vup.Normalize();
	...
	Sphere sphere1(Point3f(0,-20,60),15, Color(0,1,1),1, 1 , 0);  // middle
	Sphere sphere0(Point3f(-15,-25,40),10, Color(1,0.2,0.3),2, 1 , 0); // front most 
	Sphere sphere2(Point3f(15,-25,40),10, Color(1,0.2,0.3),2, 1 , 0); // front most 
	Sphere sphere3(Point3f(20,-20,90),15, Color(0.1,0.5,1),3, 1 , 0);
	Sphere sphere4(Point3f(-20,-20,90),15, Color(0.1,0.5,1),3, 1 , 0);
	...
	Plane plane5(Point3f(0,1,0), Point3f(0,-35,0), Color(1,1,1), "floor",0,0);
